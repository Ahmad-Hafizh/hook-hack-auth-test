...
import { Orientation, Template, DesignSettings } from "./types";
...
export const DeliverySettingsPreview: React.FC<
  DeliverySettingsPreviewProps
> = ({ onBack, onNext }) => {
...
export default DeliverySettingsPreview;
