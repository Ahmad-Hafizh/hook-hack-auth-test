    ...
    <div className="flex w-full flex-col justify-center items-center h-full gap-20">
      ...
      <div className="flex flex-col gap-4 items-center text-lg">
        ...
        <div className="flex gap-10">
          <div className=" rounded-xl text-center cursor-pointer flex flex-col justify-center items-center w-[200px] h-[200px] hover:border-black hover:shadow hover:font-bold transition-all border-gray-300 border-2" onClick={onScratch}>
            <p className="w-8/12">競合他社の​調査を​始める​</p>
          </div>
          <div
            className="  rounded-xl text-center cursor-pointer flex flex-col justify-center items-center w-[200px] h-[200px] hover:border-black hover:shadow hover:font-bold transition-all border-gray-300 border-2 leading-normal"
            onClick={onSkip}
          >
