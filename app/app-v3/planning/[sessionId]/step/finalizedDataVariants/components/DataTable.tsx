            ...
            <th className="border-b border-r border-slate-400 text-left text-xs font-bold text-slate-800 bg-slate-200 px-2 py-3 select-none whitespace-nowrap sticky top-0 z-50 shadow-sm w-[13%]">
              <div className="flex items-center gap-2">
                <input
                  ...
                  ref={(el) => {
                    if (el)
                      el.indeterminate = isSomeImagesSelected("hookImage");
                  }}
                  onChange={(e) =>
            ...
            <th className="border-b border-r border-slate-400 text-left text-xs font-bold text-slate-800 bg-slate-200 px-2 py-3 select-none whitespace-nowrap sticky top-0 z-50 shadow-sm w-[13%]">
              <div className="flex items-center gap-2">
                <input
                  ...
                  ref={(el) => {
                    if (el)
                      el.indeterminate = isSomeImagesSelected("body1Image");
                  }}
                  onChange={(e) =>
                    onSelectAllImages("body1Image", e.target.checked)
                  }
                />
                <span>Body 1{duration === 30 ? "A" : ""}</span>
              </div>
            </th>
            {duration === 30 && (
              <th className="border-b border-r border-slate-400 text-left text-xs font-bold text-slate-800 bg-slate-200 px-2 py-3 select-none whitespace-nowrap sticky top-0 z-50 shadow-sm w-[13%]">
                <div className="flex items-center gap-2">
                  <input
                    ...
                    ref={(el) => {
                      if (el)
                        el.indeterminate = isSomeImagesSelected("body1ImageB");
                    }}
                    onChange={(e) =>
            ...
            <th className="border-b border-r border-slate-400 text-left text-xs font-bold text-slate-800 bg-slate-200 px-2 py-3 select-none whitespace-nowrap sticky top-0 z-50 shadow-sm w-[13%]">
              <div className="flex items-center gap-2">
                <input
                  ...
                  ref={(el) => {
                    if (el)
                      el.indeterminate = isSomeImagesSelected("body2Image");
                  }}
                  onChange={(e) =>
                    onSelectAllImages("body2Image", e.target.checked)
                  }
                />
                <span>Body 2{duration === 30 ? "A" : ""}</span>
              </div>
            </th>
            {duration === 30 && (
              <th className="border-b border-r border-slate-400 text-left text-xs font-bold text-slate-800 bg-slate-200 px-2 py-3 select-none whitespace-nowrap sticky top-0 z-50 shadow-sm w-[13%]">
                <div className="flex items-center gap-2">
                  <input
                    ...
                    ref={(el) => {
                      if (el)
                        el.indeterminate = isSomeImagesSelected("body2ImageB");
                    }}
                    onChange={(e) =>
                  ...
                  {duration === 30 ? (
                    <>
                      <div>
                        ...
                        <textarea
                          className="w-full py-0.5 text-xs bg-transparent border-none focus:ring-0 focus:outline-none resize-none leading-snug transition-all text-slate-800 min-h-[32px]"
                          placeholder="Hook part 1..."
                          value={row.hookPart1 || ""}
                          onChange={(e) =>
                            onTextChange(index, "hookPart1", e.target.value)
                          }
                        />
                      </div>
                      ...
                      <div>
                        ...
                        <textarea
                          className="w-full py-0.5 text-xs bg-transparent border-none focus:ring-0 focus:outline-none resize-none leading-snug transition-all text-slate-800 min-h-[32px]"
                          placeholder="Hook part 2..."
                          value={row.hookPart2 || ""}
                          onChange={(e) =>
                            onTextChange(index, "hookPart2", e.target.value)
                          }
                        />
                      </div>
                    </>
                    ...
                    <textarea
                      className="w-full py-1 text-xs bg-transparent border-none focus:ring-0 focus:outline-none resize-none leading-snug transition-all text-slate-800 min-h-[60px]"
                      placeholder="Hook..."
                      value={row.hookPart1 || ""}
                      onChange={(e) =>
                        onTextChange(index, "hookPart1", e.target.value)
                  ...
                  {duration === 30 ? (
                    <>
                      <div>
                        ...
                        <textarea
                          className="w-full py-0.5 text-xs bg-transparent border-none focus:ring-0 focus:outline-none resize-none leading-snug transition-all text-slate-800 min-h-[32px]"
                          placeholder="Body1 part 1..."
                          value={row.body1Part1 || ""}
                          onChange={(e) =>
                            onTextChange(index, "body1Part1", e.target.value)
                          }
                        />
                      </div>
                      <div className="border-t border-slate-200 my-0.5" />
                      <div>
                        ...
                        <textarea
                          className="w-full py-0.5 text-xs bg-transparent border-none focus:ring-0 focus:outline-none resize-none leading-snug transition-all text-slate-800 min-h-[32px]"
                          placeholder="Body1 part 2..."
                          value={row.body1Part2 || ""}
                          onChange={(e) =>
                            onTextChange(index, "body1Part2", e.target.value)
                          }
                        />
                      </div>
                    </>
                  ...
                  {duration === 30 ? (
                    <>
                      <div>
                        ...
                        <textarea
                          className="w-full py-0.5 text-xs bg-transparent border-none focus:ring-0 focus:outline-none resize-none leading-snug transition-all text-slate-800 min-h-[32px]"
                          placeholder="Body2 part 1..."
                          value={row.body2Part1 || ""}
                          onChange={(e) =>
                            onTextChange(index, "body2Part1", e.target.value)
                          }
                        />
                      </div>
                      <div className="border-t border-slate-200 my-0.5" />
                      <div>
                        ...
                        <textarea
                          className="w-full py-0.5 text-xs bg-transparent border-none focus:ring-0 focus:outline-none resize-none leading-snug transition-all text-slate-800 min-h-[32px]"
                          placeholder="Body2 part 2..."
                          value={row.body2Part2 || ""}
                          onChange={(e) =>
                            onTextChange(index, "body2Part2", e.target.value)
                          }
                        />
                      </div>
                    </>
                  ...
                  {duration === 30 ? (
                    <>
                      <div>
                        ...
                        <textarea
                          className="w-full py-0.5 text-xs bg-transparent border-none focus:ring-0 focus:outline-none resize-none leading-snug transition-all text-slate-800 min-h-[32px]"
                          placeholder="CTA part 1..."
                          value={row.ctaPart1 || ""}
                          onChange={(e) =>
                            onTextChange(index, "ctaPart1", e.target.value)
                          }
                        />
                      </div>
                      <div className="border-t border-slate-200 my-0.5" />
                      <div>
                        ...
                        <textarea
                          className="w-full py-0.5 text-xs bg-transparent border-none focus:ring-0 focus:outline-none resize-none leading-snug transition-all text-slate-800 min-h-[32px]"
                          placeholder="CTA part 2..."
                          value={row.ctaPart2 || ""}
                          onChange={(e) =>
                            onTextChange(index, "ctaPart2", e.target.value)
                          }
                        />
                      </div>
                    </>
