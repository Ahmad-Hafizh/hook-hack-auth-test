    ...
    return NextResponse.json(
      {
        message: "Success",
        competitiveMatrix: {
          competitors: PDCASession.competitiveMatrixesNew?.competitor || [],
          suggestion: PDCASession.competitiveMatrixesNew?.suggestion || null,
          user: PDCASession.competitiveMatrixesNew?.user || null,
        },
