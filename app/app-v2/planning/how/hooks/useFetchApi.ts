...
export const submitStep2 = async ({
  ...
  try {
    ...
    setVariants({
      ...
      strong_point_2_images: [...variants.strong_point_2_images, selectedTemplateData?.images.strong_point_2],
      strong_point_3_images: [...variants.strong_point_3_images, selectedTemplateData?.images.strong_point_3],
      background_music: [
