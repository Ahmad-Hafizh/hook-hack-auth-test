  ...
  return (
    <div className="flex gap-3 pl-1">
      ...
      <div className="w-full">
        ...
        <textarea
          className="text-xs w-full bg-transparent leading-relaxed resize-none focus:outline-none focus:ring-1 focus:ring-cyan-400 rounded px-1"
          rows={4}
          value={value}
...
export const PositioningPatternCard: React.FC<PositioningPatternCardProps> = ({
  ...
  return (
    <div className="relative cursor-pointer group flex flex-col min-h-[720px] group">
      {/* <input
