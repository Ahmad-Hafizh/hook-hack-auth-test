      ...
      <div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
          ...
          <div>
            ...
            >
              <SelectTrigger id="product_category" name="product_category" className="w-full">
        ...
        <div className="mb-4">
          <Label htmlFor="functional_value">この商品が提供する主な機能的価値（特徴や強み）について教えてください。</Label>
          <Input
            id="functional_value"
        ...
        <div className="mb-4">
          <Label htmlFor="emotional_value">この商品が提供する感情的な満足や心理的価値には、どのようなものがありますか？</Label>
          <Input
            id="emotional_value"
              ...
              >
                ...
                <SelectContent>
                  {currencyOptions.map(opt => (
                    <SelectItem key={opt.value} className="min-w-[50px]" value={opt.value}>{opt.label}</SelectItem>
                  ))}
                </SelectContent>
              </Select>
              <Input
...
export const userInputSchema = z.object({
  ...
  cost: z.union([
    z.string().min(1, "価格は必須です").refine(val => !isNaN(Number(val)), "価格は数値で入力してください"),
